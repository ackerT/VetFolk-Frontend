        ...
        <div className="side-menu">
            <div className="sidebar">
                ...
                <ul id="mainMenu">
                    ...
                    <li>
                        <a href="/admin/historiacita"><FaCalendarAlt /> Agenda</a>
                    </li>
                    ...
                    <li>
                        ...
                        {isVentasOpen && (
                            <ul className="submenu">
                                <li><a href="/admin/ventas"><FaPlusCircle /> Registrar Venta</a></li>
                    ...
                    <li>
                        <a href="/admin/services"><FaStethoscope /> Servicios</a>
                    </li>
                </ul>

                <ul className="lastMenu">
                    <li>
                        <a href="/" onClick={handleLogout}><FaSignOutAlt /> Salir</a>
                    </li>
                </ul>
            </div>
        </div>
