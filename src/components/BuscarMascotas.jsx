...
const Mascotas = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <AdminSideBar/>
      <div>
        <Typography variant="h5" style={{ marginLeft: '120px' }}>Buscar Mascotas</Typography>
        <div>
          <label htmlFor="ownerQuery"style={{ marginLeft: '120px' }}>Buscar por ID o Nombre del Propietario:</label>
          <input
            type="text"
            id="ownerQuery"
            value={ownerQuery}
        ...
        {selectedOwnerPets.length > 0 && (
          <div style={{ height: 400, width: '100%', marginTop: 20 }}>
            <Typography variant="h5" style={{ marginLeft: '120px' }}>Propietario: {ownerInfo.Nombre} (ID: {ownerInfo.IdUsuario})</Typography>
            <DataGrid 
