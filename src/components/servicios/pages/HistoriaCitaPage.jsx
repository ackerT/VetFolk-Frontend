...
import { citas, estados, usuarios, comentarios, servicios, especies, citasHistoria } from '../data/CitaData';
...
export const HistoriaCitaPage = () => {
    ...
    return (
        <Box style={styles.container}>
            {/* Navbar */}
            <AppBar position="static" style={{ backgroundColor: '#ffffff', color: '#00897b' }}>
                <Toolbar>
                    <Typography variant="h6" style={{ flexGrow: 1, color: '#00897b' }}>
                        VetFolk
                    </Typography>
                    <Button href="/admin/cita" style={styles.button}>Inicio</Button>
                    <Button href="/citas" style={styles.button}>Citas</Button>
                    <Button href="/admin" style={styles.button}>Admin</Button>
                </Toolbar>
            </AppBar>
            ...
            {/* Tabla de citas */}
            <TableContainer component={Paper} style={{ width: '100%', height: '100%', overflow: 'auto' }}>
                <Table stickyHeader>
                    <TableHead>
                        <TableRow>
